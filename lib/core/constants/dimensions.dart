...
extension Dimension on double {
  double get dynamicH =>
      !kIsWeb && (Platform.isIOS || Platform.isAndroid) ? h : this;

  double get dynamicW =>
      !kIsWeb && (Platform.isIOS || Platform.isAndroid) ? w : this;

  double get dynamicSP =>
      !kIsWeb && (Platform.isIOS || Platform.isAndroid) ? sp : this;

  double get dynamicR =>
      !kIsWeb && (Platform.isIOS || Platform.isAndroid) ? r : this;
}
...
class Dimensions {
  ...
  static double commonRadius = Dimensions.r8;
  static double commonButtonHeight = Dimensions.h35;
  ...
  static double w205 = 205.0.dynamicW;
  static double w213 = 213.0.dynamicW;
  static double w230 = 230.0.dynamicW;
  static double w236 = 236.0.dynamicW;
